...
//example:components shift of 6 bits--> result on (14-6)*2=8*2=16 bits 
//y final to (14-6)+1=8+1=9 bit (consider overflow)
//16-9= 7 bits shift
  return y;
}
